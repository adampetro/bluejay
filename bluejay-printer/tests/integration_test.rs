...
fn test_printer() {
    ...
    let original_document_definition_count = original_document.definition_count();
    ...
    let printed_document_definition_count = printed_document.definition_count();
    ...
    assert_eq!(
        original_document_definition_count,
        printed_document_definition_count,
    );
